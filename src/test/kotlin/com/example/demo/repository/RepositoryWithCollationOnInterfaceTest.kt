...
@DataMongoTest
@Testcontainers
class RepositoryWithCollationOnInterfaceTest {
    ...
    @Autowired
    private lateinit var repository: RepositoryWithCollationOnInterface

    @Nested
    inner class `when using custom findAll with query annotation` {
        @Test
        fun `should have correct sorting for numbers`() {
            ...
            assertThat(repository.findAllCustom()).containsExactly(first, second, third, fourth)
        }
    }

    @Nested
    inner class `when using CRUD findAll annotation` {
        ...
        fun `should have correct sorting for numbers`() {
            ...
            assertThat(repository.findAll()).containsExactly(first, second, third, fourth)
        }
    }
}